            	...
            	<div class="md:grid md:grid-cols-3 gap-2 ">
            		...
            		<div class="col-span-2 p-5">
            			...
            			<div class="flex justify-between items-center mt-6 pt-6">
            				<div class="flex  items-center">
            					...
            					<div class="flex flex-col ml-3">
            						<span class="md:text-md font-medium">Chicken Mcdonalds</span>
            				...
            				<div class="flex justify-center items-center">
            					...
            					<div class="pr-8 ">
            						...
            						<span class="text-xs font-medium">Rp.30.000</span>
            					</div>
            					<div>
            			...
            			<div class="flex justify-between items-center pt-6 mt-6 border-t">
            				<div class="flex  items-center">
            					...
            					<div class="flex flex-col ml-3 ">
            						<span class="text-md font-medium w-auto">Spicy potatoes</span>
            				...
            				<div class="flex justify-center items-center">
            					...
            					<div class="pr-8">
            						...
            						<span class="text-xs font-medium">Rp.35.000</span>
            					</div>
            					<div>
            						<i class="fa fa-close text-xs font-medium"></i>
            					</div>
            			...
            			<div class="flex justify-between items-center mt-6 pt-6 border-t">
            				<div class="flex  items-center">
            					<img src="roti.jpg" width="60" class="rounded-full ">

            					<div class="flex flex-col ml-3 ">
            						<span class="text-md font-medium">Bread</span>
            				...
            				<div class="flex justify-center items-center">
            					...
            					<div class="pr-8">
            						...
            						<span class="text-xs font-medium">Rp.15.000</span>
            					</div>
            					<div>
            						<i class="fa fa-close text-xs font-medium"></i>
            					</div>
            			...
            			<div class="flex justify-between items-center mt-6 pt-6 border-t"> 
            				...
            				<div class="flex justify-center items-end">
            					...
            					<span class="text-lg font-bold text-gray-800 "> Rp.80.000</span>
            		...
            		<div class=" p-5 bg-gray-800 rounded overflow-visible">
            			...
            			<div class="overflow-visible flex justify-between items-center mt-2">
            				...
            				<div class="rounded w-52 h-28 bg-gray-500 py-2 px-4 relative right-10">
            					...
            					<div class="flex justify-between items-center mt-3">
            						...
            						<span class="text-xs  text-gray-200">Dewa Putu Indra Sunarya</span>
            						<span class="text-xs  text-gray-200">21/25</span>
            					</div>
            			...
            			<div class="flex justify-center flex-col pt-3">
            				...
            				<input type="text" class="focus:outline-none w-full h-6 bg-gray-800 text-white placeholder-gray-300 text-sm border-b border-gray-600 py-4" placeholder="Dewa Putu Indra Sunarya">
            			</div>
